...
#' Simulate spatially auto-correlated values
#'
#' Simulate spatially auto-correlated values for a spatial dataset.
#'
#' @param x [sf::st_sf()] or [raster::raster()] object.
#'
#' @param n `ineger` number of layers/fields to simulate.
#'   Defaults to 1.
#'
#' @return [sf::st_sf()] or [raster::raster()] object with values.
#'
#' @noRd
simulate_spatial_autocorrelated_values <- function(x, n = 1) {
